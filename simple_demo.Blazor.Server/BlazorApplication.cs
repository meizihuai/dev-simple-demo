...
namespace simple_demo.Blazor.Server {
    public partial class simple_demoBlazorApplication : BlazorApplication {
        public simple_demoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void simple_demoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
